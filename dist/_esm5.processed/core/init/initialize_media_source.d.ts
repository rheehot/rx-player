 ...
 * @returns {Observable}
 */
export default function InitializeOnMediaSource({ adaptiveOptions, autoPlay, bufferOptions, clock$, keySystems, lowLatencyMode, manifestUpdateUrl, mediaElement, minimumManifestUpdateInterval, networkConfig, pipelines, speed$, startAt, textTrackOptions, url }: IInitializeArguments): Observable<IInitEvent>;

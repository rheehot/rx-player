...
export default function createManifestPipeline(pipelines, pipelineOptions, warning$) {
    ...
    function scheduleRequest(request) {
        ...
        return tryRequestObservableWithBackoff(tryCatch(request, undefined), backoffOptions).pipe(mergeMap(function (evt) {
            if (evt.type === "retry") {
    ...
    return {
        ...
        parse: function (value, fetchedURL, externalClockOffset) {
            var sendingTime = value.sendingTime, receivedTime = value.receivedTime;

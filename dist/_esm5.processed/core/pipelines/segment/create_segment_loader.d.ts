 ...
 * @returns {Function}
 */
export default function createSegmentLoader<T>(loader: ISegmentPipelineLoader<T>, options: ISegmentPipelineLoaderOptions<T>): (x: IContent) => Observable<IPipelineLoaderEvent<T>>;
